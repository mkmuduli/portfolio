const Desktop = (props) => {
  return (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
      <path
        opacity="0.1"
        d="M3.58579 3.58579C3 4.17157 3 5.11438 3 7V13H21V7C21 5.11438 21 4.17157 20.4142 3.58579C19.8284 3 18.8856 3 17 3H7C5.11438 3 4.17157 3 3.58579 3.58579Z"
        fill={"currentColor"}
      />
      <path
